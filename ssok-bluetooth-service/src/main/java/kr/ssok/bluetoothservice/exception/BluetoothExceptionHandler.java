 ...
 */
@RestControllerAdvice(basePackages = "kr.ssok.bluetoothservice")
public class BluetoothExceptionHandler {

    /**
     * TransferException 처리
     */
    @ExceptionHandler(BluetoothException.class)
    public ResponseEntity<BaseResponse<?>> handleTransferException(BluetoothException e) {
